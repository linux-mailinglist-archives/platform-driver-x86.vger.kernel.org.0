Return-Path: <platform-driver-x86+bounces-7096-lists+platform-driver-x86=lfdr.de@vger.kernel.org>
X-Original-To: lists+platform-driver-x86@lfdr.de
Delivered-To: lists+platform-driver-x86@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id D4C759D18FC
	for <lists+platform-driver-x86@lfdr.de>; Mon, 18 Nov 2024 20:33:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 43D82B211A0
	for <lists+platform-driver-x86@lfdr.de>; Mon, 18 Nov 2024 19:33:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EDA5C1E633B;
	Mon, 18 Nov 2024 19:32:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=tuxedocomputers.com header.i=@tuxedocomputers.com header.b="Ia9xygf5"
X-Original-To: platform-driver-x86@vger.kernel.org
Received: from mail.tuxedocomputers.com (mail.tuxedocomputers.com [157.90.84.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2AD391E572A
	for <platform-driver-x86@vger.kernel.org>; Mon, 18 Nov 2024 19:32:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=157.90.84.7
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731958372; cv=none; b=pZUcSyJUfAccjYL67Tc3v3rWnSAdP3kf40Y8P6WR4RVgGCYu2IFhz/vgyuWjfXPIwK/ln1gU1Ed3vCPcz65wWinn4s80WFothgX5zX6v3rld0IiAYsIaBb3XzVX0ysuXamf8QhXJF1rDzehjIm7WruWNMHIyR4SIPGMoTUrz540=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731958372; c=relaxed/simple;
	bh=nYN7+G5KNMfQJdG8Mxumkn96cu6e2DM92xQHaDCxFa0=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=TReVYrMWkGHi8J65d0xsTLQ3aeHRqyOJfvhz2nSHR3onHWwf+wDVB+SZf4xgGGej3x2Wa/xjFwuzFW/44ie+XPnVdiq2juCJ9e1pKYBymQQopg9qC5K3Cb192QG3l5CE9CH29No0h1xbbZud0q31s4YVP92JPvUNQpurBtPf2uU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tuxedocomputers.com; spf=pass smtp.mailfrom=tuxedocomputers.com; dkim=pass (1024-bit key) header.d=tuxedocomputers.com header.i=@tuxedocomputers.com header.b=Ia9xygf5; arc=none smtp.client-ip=157.90.84.7
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tuxedocomputers.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=tuxedocomputers.com
Received: from [192.168.42.96] (p5de457db.dip0.t-ipconnect.de [93.228.87.219])
	(Authenticated sender: wse@tuxedocomputers.com)
	by mail.tuxedocomputers.com (Postfix) with ESMTPSA id 2FE982FC004D;
	Mon, 18 Nov 2024 20:32:46 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=tuxedocomputers.com;
	s=default; t=1731958366;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=8i8FascDk3m1cz2QLtN7mOCRE63xlqQ0t8TfNvMuw7k=;
	b=Ia9xygf5RaOuQVL5lC6KcRJxB/sJz4FKw+Y5pMd4HIYDGWPjNZfA/IwCRcrpI7riwH6Pe5
	V0kb2C/q156aFxmvMoUyt8zCprtMCnhQMJYDKHIgmC42t9h25X3KTg/3PNJEWPx+r9SONk
	rESuBFVXlhpDYxJTFRq32IR0o1aQoGc=
Authentication-Results: mail.tuxedocomputers.com;
	auth=pass smtp.auth=wse@tuxedocomputers.com smtp.mailfrom=wse@tuxedocomputers.com
Message-ID: <ce23b495-a274-462f-8800-3f8a08cc2aa5@tuxedocomputers.com>
Date: Mon, 18 Nov 2024 20:32:46 +0100
Precedence: bulk
...
In-Reply-To: <b671f3f7-5d48-4534-831b-3b357bcd7f6a@gmx.de>
...
>>>
> The ACPI interface allows for manual fan control, something the WMI interface 
> does not support.
oh you got me wrong here: the wmi interface also supports fan control (albeit 
I'm not sure if it is implemented in tuxedo-drivers)
>
...
>
> AFAIK i think this should normally be done at the BIOS level, but if only a 
> limited number of devices are affected then this should be fine.
>
> Thanks,
> Armin Wolf
>
