Return-Path: <platform-driver-x86+bounces-9166-lists+platform-driver-x86=lfdr.de@vger.kernel.org>
X-Original-To: lists+platform-driver-x86@lfdr.de
Delivered-To: lists+platform-driver-x86@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 94EA3A25CF1
	for <lists+platform-driver-x86@lfdr.de>; Mon,  3 Feb 2025 15:41:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id DFDD47A1A2B
	for <lists+platform-driver-x86@lfdr.de>; Mon,  3 Feb 2025 14:41:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0873B209673;
	Mon,  3 Feb 2025 14:32:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="O1caCaPd"
X-Original-To: platform-driver-x86@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 705C520E71F
	for <platform-driver-x86@vger.kernel.org>; Mon,  3 Feb 2025 14:32:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.14
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738593154; cv=none; b=D5Uic8Hp0qwZF0gRusey0Jts6yAVdRPwyksMEVEgQD4nRLKs1B9fl2SjIujy8JaqYjxXSp0IrdG4dwmMitA/ZXVjQDO361gAOTdeuvz1hqltRWnJSPkf+syJ3O3JUnQZksjP4Rm4WKgGy7g3tglr2IbB3eH66q1tfjRXCla7RJM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738593154; c=relaxed/simple;
	bh=gGXS5cB32blggmlrC/fVhGQhI5LaLH3Z9U8XJo2WpLE=;
	h=From:Date:To:cc:Subject:In-Reply-To:Message-ID:References:
	 MIME-Version:Content-Type; b=VNcuY9SzVateIhDBx5tV+au7vodjI9u2x/VmN6ljeeh137XN3lDFFkwHqji2Xas16xtLR8wJAo/BCKydC+T2xwm5nFw1JS427sR33xZj4+NF57sIxn7ZbiIcxfndqnT3rAYglFf9S9gUMIHOOdTJx4k/lSlmj4A1Za+TT/jFaQI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com; spf=none smtp.mailfrom=linux.intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=O1caCaPd; arc=none smtp.client-ip=198.175.65.14
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1738593152; x=1770129152;
  h=from:date:to:cc:subject:in-reply-to:message-id:
   references:mime-version;
  bh=gGXS5cB32blggmlrC/fVhGQhI5LaLH3Z9U8XJo2WpLE=;
  b=O1caCaPdNvzqs53kL/5O1dJpz0oH1PGGSA/Bq6olahHeIjlTfD1OtzrJ
   e+vNAwLpjXxu3Bxtce63De+tKUjnVqXDVGkI0CObc2KFMwzsLtR+I/jCR
   zsmkdFRsCgQ8dgq6kJi+n0e2exQd2m43SxG7B8iB4ZoXGo5SCdybGvuzb
   4Q2sZXLDXZU8P2y5eCXvvGtK8uakhQTOnoVb1YuYRpAAdA7qsnU2oG0Oh
   HNX/l/0oJ/op7RJkPvGlJ7mWZMRKK9FanzJg45pZkw/UtocCKcMCQABBc
   F8K6/szq+LB+psHJCxiUioPmyDwYhyKzcxhzbKP4F/mDUr32YcLEZw/95
   g==;
X-CSE-ConnectionGUID: QkrmgNSbSdagFJUc1lGCGQ==
X-CSE-MsgGUID: y4MtKX+xQ7eyafCAYhKE9g==
X-IronPort-AV: E=McAfee;i="6700,10204,11335"; a="42836397"
X-IronPort-AV: E=Sophos;i="6.13,256,1732608000"; 
   d="scan'208";a="42836397"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
  by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Feb 2025 06:32:31 -0800
X-CSE-ConnectionGUID: yaE+yl2wRBeH/bjtrNaoQg==
X-CSE-MsgGUID: fB93VhcmSD2nytDjaRpAcw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; 
   d="scan'208";a="114926178"
Received: from ijarvine-mobl1.ger.corp.intel.com (HELO localhost) ([10.245.245.194])
  by fmviesa005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Feb 2025 06:32:26 -0800
From: =?UTF-8?q?Ilpo=20J=C3=A4rvinen?= <ilpo.jarvinen@linux.intel.com>
Date: Mon, 3 Feb 2025 16:32:22 +0200 (EET)
To: Vadim Pasternak <vadimp@nvidia.com>
cc: ilpo.jarvinen@linux.intel.com, hdegoede@redhat.com, michaelsh@nvidia.com, 
    crajank@nvidia.com, fradensky@nvidia.com, oleksandrs@nvidia.com, 
    platform-driver-x86@vger.kernel.org
Subject: Re: [PATCH v5 08/12] platform: mellanox: Introduce support of Nvidia
 smart switch
In-Reply-To: <20250124172632.22437-9-vadimp@nvidia.com>
Message-ID: <e4d06946-fa24-0e6e-098f-c7f4e970027b@linux.intel.com>
References: <20250124172632.22437-1-vadimp@nvidia.com> <20250124172632.22437-9-vadimp@nvidia.com>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="8323328-1573103002-1738593142=:934"

  This message is in MIME format.  The first part should be readable text,
  while the remaining parts are likely unreadable without MIME-aware tools.

--8323328-1573103002-1738593142=:934
...
Missing comma, please check with grep you don't have others similar lines.
...
IMO, this could be just one line, only the comma goes beyond 80 chars so=20
no important information is missing even on 80 chars terminal.
