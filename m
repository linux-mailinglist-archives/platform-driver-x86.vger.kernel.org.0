Return-Path: <platform-driver-x86+bounces-8790-lists+platform-driver-x86=lfdr.de@vger.kernel.org>
X-Original-To: lists+platform-driver-x86@lfdr.de
Delivered-To: lists+platform-driver-x86@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 4AE9DA1557E
	for <lists+platform-driver-x86@lfdr.de>; Fri, 17 Jan 2025 18:12:46 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id E9284188B587
	for <lists+platform-driver-x86@lfdr.de>; Fri, 17 Jan 2025 17:12:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DA7D019F41C;
	Fri, 17 Jan 2025 17:12:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="FSwYkR8W"
X-Original-To: platform-driver-x86@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 30B8913792B
	for <platform-driver-x86@vger.kernel.org>; Fri, 17 Jan 2025 17:12:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.12
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1737133962; cv=none; b=VK+OhphhTsTc0L6k5FMwDvQ4OrsKLlP1acYa691qe8X4WQnuk0Sox74+gEhxm+xq4QCvibpFRccyjWXyO+whZA61lhbXLupcSX2rdz+eAYYDStRao9i+4bT5c4iDwFk5BVl/816BLEPSGosy2MDH6eClpjGxamR6IQtLqQgHJZs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1737133962; c=relaxed/simple;
	bh=K/iJLM+n0TTWtEvtYvb7/xM6IPUyVylZQ55BG7/x+fo=;
	h=From:Date:To:cc:Subject:In-Reply-To:Message-ID:References:
	 MIME-Version:Content-Type; b=L6UxewxCSZ5VWg7JUb4C+qOjmeyBNcyeF0dr8Wc7I4Kq6VNHbDlkxISq/PkwWOEcLS3e5Iw9oKhoN+6efk8KrFDi9C1FemqkX57wbYWtse+2gJ5iYpeG1jmjAlRa3scZp1wpQzG9qX6xjnsB7GJCFTs4jhoKiB5mfziUtaqGgg4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com; spf=none smtp.mailfrom=linux.intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=FSwYkR8W; arc=none smtp.client-ip=198.175.65.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1737133959; x=1768669959;
  h=from:date:to:cc:subject:in-reply-to:message-id:
   references:mime-version;
  bh=K/iJLM+n0TTWtEvtYvb7/xM6IPUyVylZQ55BG7/x+fo=;
  b=FSwYkR8WKFs53EIhw9d9NfGDqml7pUIBVQ+Q1KsB46q4Go/XmNuDAIuF
   EHSw2B686+860N0yGhsZjDkFq2Pix8hnlrLGaDd9HH8sezao+mX1YVqhY
   irsSWTNjkmvJCywqwScd1hO3YIW44EDlMrqCG/T/4HjnTFbO3BgCqYZrK
   2y8kj+J3C8yK0U+8/Q/zwUAEgDRymWzMqvCUaJndWrcPukYqpTS/SjB1v
   3sYhOljO8BC/TG8Hp0pdkN+9uUOfuH5EKJLSrsMplp0jv3AzE1s0OWvrz
   daHPpqbMH25qGCxjH9q8Dbp2sfb4peiZXootyrzIwN5iOObEjJWEk1OXI
   g==;
X-CSE-ConnectionGUID: AMCt9+ieTf+rAt7LtOJHBA==
X-CSE-MsgGUID: bgnlb0NxTP+p5T/6hQ5Vzg==
X-IronPort-AV: E=McAfee;i="6700,10204,11318"; a="48964934"
X-IronPort-AV: E=Sophos;i="6.13,212,1732608000"; 
   d="scan'208";a="48964934"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
  by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Jan 2025 09:12:39 -0800
X-CSE-ConnectionGUID: iTJsbaQ+S9S0XbcBH0ip4A==
X-CSE-MsgGUID: hnobS0pvQBiobCywBJbz4Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,212,1732608000"; 
   d="scan'208";a="105652231"
Received: from ijarvine-mobl1.ger.corp.intel.com (HELO localhost) ([10.245.244.76])
  by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Jan 2025 09:12:35 -0800
From: =?UTF-8?q?Ilpo=20J=C3=A4rvinen?= <ilpo.jarvinen@linux.intel.com>
Date: Fri, 17 Jan 2025 19:12:31 +0200 (EET)
...
Subject: Re: [PATCH v3 07/10] platform: mellanox: Introduce support of Nvidia
 smart switch
In-Reply-To: <20250116075919.34270-8-vadimp@nvidia.com>
Message-ID: <1a660ffc-7bd8-15bf-a4f0-e56798539f00@linux.intel.com>
References: <20250116075919.34270-1-vadimp@nvidia.com> <20250116075919.34270-8-vadimp@nvidia.com>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="8323328-916466141-1737133951=:932"

  This message is in MIME format.  The first part should be readable text,
  while the remaining parts are likely unreadable without MIME-aware tools.

--8323328-916466141-1737133951=:932
...
Thank for the better diff, much nicer to read now :-).

In this function too, I suggest to separate the for loops with an empty=20
line before and after the two loops so the long continuous text is broken=
=20
a bit.
...
I see there are lines with this style, but this is same as the more=20
concise form:
...
=2E..here the usual style is to not have empty space after the condition:

=09for (i =3D MLXPLAT_CPLD_DPU_MAX_DEVS - 1; i >=3D 0; i--)

Neither of these two is mandatory to change, IMO, so it's up to you if=20
want to follow my suggestions (especially given the similar lines around=20
the code).
