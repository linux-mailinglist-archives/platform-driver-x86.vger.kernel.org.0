...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 99E553FDC6E
	for <lists+platform-driver-x86@lfdr.de>; Wed,  1 Sep 2021 15:19:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344510AbhIAMuy (ORCPT
        <rfc822;lists+platform-driver-x86@lfdr.de>);
        Wed, 1 Sep 2021 08:50:54 -0400
Received: from mga09.intel.com ([134.134.136.24]:58603 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1344537AbhIAMsA (ORCPT
        <rfc822;platform-driver-x86@vger.kernel.org>);
        Wed, 1 Sep 2021 08:48:00 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10093"; a="218746847"
X-IronPort-AV: E=Sophos;i="5.84,369,1620716400"; 
   d="scan'208";a="218746847"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Sep 2021 05:42:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.84,369,1620716400"; 
   d="scan'208";a="460810027"
Received: from sumeshkkn (HELO localhost.localdomain) ([10.223.97.2])
  by fmsmga007.fm.intel.com with ESMTP; 01 Sep 2021 05:42:41 -0700
...
Subject: [PATCH v3 1/1] ishtp: Add support for Intel ishtp eclite driver
Date:   Wed,  1 Sep 2021 18:13:07 +0530
Message-Id: <20210901124307.16886-1-sumesh.k.naduvalath@intel.com>
...
-Initial Version
 ...
 drivers/platform/x86/intel_ishtp_eclite.c | 701 ++++++++++++++++++++++
 4 files changed, 724 insertions(+)
 create mode 100644 drivers/platform/x86/intel_ishtp_eclite.c

diff --git a/MAINTAINERS b/MAINTAINERS
index f3267183e993..ea77785e6a1c 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -9416,6 +9416,12 @@ L:	linux-crypto@vger.kernel.org
 S:	Maintained
