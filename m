...
Subject: [PATCH v3 14/36] platform/x86: intel_scu_ipc: Introduce new SCU IPC API
Date:   Mon, 13 Jan 2020 16:56:01 +0300
Message-Id: <20200113135623.56286-15-mika.westerberg@linux.intel.com>
...
---
 ...
 drivers/platform/x86/intel_scu_ipc.c        | 229 +++++++++++++++-----
...
index d6feb96d98e3..1a76e874657e 100644
...
@@ -31,46 +30,39 @@ struct intel_scu_ipc_pdata {
 	int irq;
 };
...
index 513d0dd1cac8..a729319fd708 100644
...
+ * @scu: Optional SCU IPC instance
  ...
  * @data: Bytes to write
  * @len: Length of array
@@ -282,16 +384,18 @@ EXPORT_SYMBOL(intel_scu_ipc_readv);
  *
  * This function may sleep.
  */
-int intel_scu_ipc_writev(u16 *addr, u8 *data, int len)
...
@@ -401,19 +528,20 @@ static irqreturn_t ioc(int irq, void *dev_id)
  * @dev: SCU device
...
@@ -421,16 +549,19 @@ int intel_scu_ipc_probe(struct device *dev, const struct intel_scu_ipc_pdata *pd
