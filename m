...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6406818E267
	for <lists+platform-driver-x86@lfdr.de>; Sat, 21 Mar 2020 16:22:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727314AbgCUPW6 (ORCPT
        <rfc822;lists+platform-driver-x86@lfdr.de>);
        Sat, 21 Mar 2020 11:22:58 -0400
Received: from out4-smtp.messagingengine.com ([66.111.4.28]:56133 "EHLO
        out4-smtp.messagingengine.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727244AbgCUPW6 (ORCPT
        <rfc822;platform-driver-x86@vger.kernel.org>);
        Sat, 21 Mar 2020 11:22:58 -0400
Received: from compute1.internal (compute1.nyi.internal [10.202.2.41])
        by mailout.nyi.internal (Postfix) with ESMTP id 47DDA5C02EE;
        Sat, 21 Mar 2020 11:22:56 -0400 (EDT)
Received: from imap27 ([10.202.2.77])
  by compute1.internal (MEProxy); Sat, 21 Mar 2020 11:22:56 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=mxxn.io; h=
        mime-version:message-id:in-reply-to:references:date:from:to:cc
        :subject:content-type:content-transfer-encoding; s=fm1; bh=URJMj
        rrv/H0mfZlxJyBnTW5LbSVdRtcdpKaInKs+sOQ=; b=oVLVC4Deizh8+4680gq2O
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:content-transfer-encoding:content-type
        :date:from:in-reply-to:message-id:mime-version:references
        :subject:to:x-me-proxy:x-me-proxy:x-me-sender:x-me-sender
        :x-sasl-enc; s=fm2; bh=URJMjrrv/H0mfZlxJyBnTW5LbSVdRtcdpKaInKs+s
        OQ=; b=XCRrdJs90lwve4fInyRtAn12/e8YiTxfz40kOgEoMoecEcU3blWtbsVvM
        
X-ME-Sender: <xms:TzF2XvRdG-v8UOxhu22q7ZamizB413SC-zhx21YduJFljs4DzICQvQ>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgedugedrudegfedgjeeiucetufdoteggodetrfdotf
    ...
    necurfgrrhgrmhepmhgrihhlfhhrohhmpegslhgriiesmhiggihnrdhioh
X-ME-Proxy: <xmx:UDF2XjVOBjV3ZbK6rtmSOtOZIB17ATJWdLdRfeJXs9OvUIPjfyRuhg>
    <xmx:UDF2Xr-xLZcOFZvl1NSZe5XeSY6Mwh10_OpP0uRCWPCWHCwHA9_izg>
    <xmx:UDF2XnQOK-mOz2H5slt3G_1mqqiQKvJAgbIchU3z9AWGNQBcom7Mpw>
    <xmx:UDF2XogDcmo3qeVtpYXJ6whOBcuZMmKTYA1ib5OuzrDuKo-gRy-pmg>
Received: by mailuser.nyi.internal (Postfix, from userid 501)
        id CB53AD2009F; Sat, 21 Mar 2020 11:22:55 -0400 (EDT)
X-Mailer: MessagingEngine.com Webmail Interface
User-Agent: Cyrus-JMAP/3.1.7-1021-g152deaf-fmstable-20200319v1
Mime-Version: 1.0
Message-Id: <22d7d367-0bec-426c-a458-031877f186a4@www.fastmail.com>
In-Reply-To: <CAHp75VeCm_0+AknrnEyEioCtiZT_VzPZUrsjns3UaObogoMoPA@mail.gmail.com>
References: <a53f7cc8-a054-4afb-b8d6-a318347614c5@www.fastmail.com>
 ...
 <eb437cb4-9e11-4f94-98f0-f7a1011c0570@www.fastmail.com>
 <CAHp75VeCm_0+AknrnEyEioCtiZT_VzPZUrsjns3UaObogoMoPA@mail.gmail.com>
Date:   Sat, 21 Mar 2020 15:22:22 +0000
From:   =?UTF-8?Q?Bla=C5=BE_Hrastnik?= <blaz@mxxn.io>
To:     "Andy Shevchenko" <andy.shevchenko@gmail.com>
Cc:     "Platform Driver" <platform-driver-x86@vger.kernel.org>,
        "Benjamin Tissoires" <benjamin.tissoires@redhat.com>
Subject: =?UTF-8?Q?[PATCH]_[v5]_platform/x86:_surface3=5Fpower:_MSHW0011_rev-eng_?=
