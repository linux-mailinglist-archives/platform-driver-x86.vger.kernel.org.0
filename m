...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C4BA63B9AAD
	for <lists+platform-driver-x86@lfdr.de>; Fri,  2 Jul 2021 04:23:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234689AbhGBCZp (ORCPT
...
Received: from mga02.intel.com ([134.134.136.20]:30676 "EHLO mga02.intel.com"
        ...
        Thu, 1 Jul 2021 22:25:45 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10032"; a="195824213"
X-IronPort-AV: E=Sophos;i="5.83,316,1616482800"; 
   d="scan'208";a="195824213"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Jul 2021 19:23:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.83,316,1616482800"; 
   d="scan'208";a="426361060"
Received: from otcpl-manager.jf.intel.com (HELO localhost.localdomain) ([10.54.39.234])
  by orsmga002.jf.intel.com with ESMTP; 01 Jul 2021 19:23:13 -0700
...
Subject: [PATCH v1 3/4] platform/x86: intel_pmc_core: Add Alder Lake low power mode support for pmc_core
Date:   Thu,  1 Jul 2021 19:20:02 -0700
Message-Id: <f31f15ec9c1e6ee72bb8525c64878d222e1fa09e.1625191274.git.gayatri.kammela@intel.com>
...
---
 drivers/platform/x86/intel_pmc_core.c | 194 ++++++++++++++++++++++++++
