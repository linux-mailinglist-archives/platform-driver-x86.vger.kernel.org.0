...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0A40F3C368E
	for <lists+platform-driver-x86@lfdr.de>; Sat, 10 Jul 2021 21:52:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231550AbhGJTyN (ORCPT
        <rfc822;lists+platform-driver-x86@lfdr.de>);
        Sat, 10 Jul 2021 15:54:13 -0400
Received: from mga12.intel.com ([192.55.52.136]:30473 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231474AbhGJTyN (ORCPT
        <rfc822;platform-driver-x86@vger.kernel.org>);
        Sat, 10 Jul 2021 15:54:13 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10041"; a="189524581"
X-IronPort-AV: E=Sophos;i="5.84,229,1620716400"; 
   d="scan'208";a="189524581"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Jul 2021 12:51:27 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.84,229,1620716400"; 
   d="scan'208";a="411671340"
Received: from otcpl-manager.jf.intel.com (HELO localhost.localdomain) ([10.54.39.234])
  by orsmga006.jf.intel.com with ESMTP; 10 Jul 2021 12:51:27 -0700
...
Subject: [PATCH v3 1/5] platform/x86/intel: intel_pmc_core: Move intel_pmc_core* files to pmc subfolder
Date:   Sat, 10 Jul 2021 12:48:13 -0700
Message-Id: <c67632e353bc2c3d430bd795403010df54cc1c51.1625944730.git.gayatri.kammela@intel.com>
...
---
 ...
 .../{intel_pmc_core.c => intel/pmc/core.c}    |  0
 .../{intel_pmc_core.h => intel/pmc/core.h}    |  0
 .../pmc/pltdrv.c}                             |  0
 9 files changed, 29 insertions(+), 22 deletions(-)
 create mode 100644 drivers/platform/x86/intel/pmc/Kconfig
 create mode 100644 drivers/platform/x86/intel/pmc/Makefile
 rename drivers/platform/x86/{intel_pmc_core.c => intel/pmc/core.c} (100%)
