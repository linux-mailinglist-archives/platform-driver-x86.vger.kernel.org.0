...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B18F8144163
	for <lists+platform-driver-x86@lfdr.de>; Tue, 21 Jan 2020 17:05:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729325AbgAUQCj (ORCPT
        <rfc822;lists+platform-driver-x86@lfdr.de>);
        Tue, 21 Jan 2020 11:02:39 -0500
Received: from mga04.intel.com ([192.55.52.120]:46956 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729417AbgAUQBa (ORCPT
...
Subject: [PATCH v4 25/38] platform/x86: intel_pmc_ipc: Start using SCU IPC
Date:   Tue, 21 Jan 2020 19:01:01 +0300
Message-Id: <20200121160114.60007-26-mika.westerberg@linux.intel.com>
...
index 8527327d88c7..4d9c9fd082ad 100644
...
+	ret = intel_scu_ipc_dev_simple_command(scu, cmd, subcmd);
 	if (ret) {
 		...
 		return ret;
@@ -507,6 +285,7 @@ static ssize_t intel_pmc_ipc_northpeak_store(struct device *dev,
 					     struct device_attribute *attr,
 					     const char *buf, size_t count)
 {
+	struct intel_scu_ipc_dev *scu = dev_get_drvdata(dev);
 	...
 	int subcmd;
 	int ret;
@@ -518,7 +297,7 @@ static ssize_t intel_pmc_ipc_northpeak_store(struct device *dev,
 		subcmd = 1;
 	else
 		subcmd = 0;
...
+	ret = intel_scu_ipc_dev_simple_command(scu, PMC_IPC_NORTHPEAK_CTRL, subcmd);
 	if (ret) {
 		...
 		return ret;
@@ -711,9 +490,11 @@ static int ipc_create_pmc_devices(void)
 	return ret;
 }
...
@@ -782,23 +563,30 @@ static int ipc_plat_get_res(struct platform_device *pdev)
...
+	ipcdev.gcr_mem_base = addr;
 	...
 	res = platform_get_resource(pdev, IORESOURCE_MEM,
@@ -851,49 +639,43 @@ MODULE_DEVICE_TABLE(acpi, ipc_acpi_ids);
...
@@ -904,7 +686,6 @@ static int ipc_plat_probe(struct platform_device *pdev)
