Return-Path: <platform-driver-x86+bounces-4295-lists+platform-driver-x86=lfdr.de@vger.kernel.org>
X-Original-To: lists+platform-driver-x86@lfdr.de
Delivered-To: lists+platform-driver-x86@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4290C92DD40
	for <lists+platform-driver-x86@lfdr.de>; Thu, 11 Jul 2024 02:03:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id ED414280D37
	for <lists+platform-driver-x86@lfdr.de>; Thu, 11 Jul 2024 00:03:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5E36ED2E6;
	Thu, 11 Jul 2024 00:02:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="YlaxUqhE"
X-Original-To: platform-driver-x86@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 89C079441;
	Thu, 11 Jul 2024 00:02:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.15
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1720656173; cv=none; b=cZ0kMb5Lm9KVEPtg498kQ8dgnshoxRRQWD52tghp8c3+jzkCJON2RgX5Tb7Svw2lyuzgqM3jd1sVlZNIVXxc7x/VRh7qncB8cpxNrmV6v9jli/thaN1ZGvfXCz6NHdAFfqrjQENowQr9H10v5W5HuVJJVeXbHbTSrI6dELNrQ5w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1720656173; c=relaxed/simple;
	bh=RjOjSaOw+6S8vVPsbN1OOk3EfkY8SHQtwkH8pBVqILc=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=OnwhuEsN6+2LMuePojgYIYUtQi0uluo6JA5pYQRbSqKtWJTx1IbO2cRYHp6UJpcZVpmTYpHDgbY9+/2LpK8iut9FFOcLCB+Sp/36yIlJS5q+V4tigaYWO+yohGNfa0ODmMIGxcHtCTpUuAloDqReOWExdjriRi9qfV46fC782k0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com; spf=none smtp.mailfrom=linux.intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=YlaxUqhE; arc=none smtp.client-ip=192.198.163.15
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1720656171; x=1752192171;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=RjOjSaOw+6S8vVPsbN1OOk3EfkY8SHQtwkH8pBVqILc=;
  b=YlaxUqhEhcyA4L+EOtMpss3oI9VgNw4lXHR5qqiwOK/n1mVvW1ED8pA4
   xr4mcmx5nTErMmIWmELZxVFoY0gIQsNycVphCmrxah2hQ0ntfb5dwz1ka
   370d2ezyJMAvIKotQC2hqiqE75SuU8Bsec3bkmoEN/K0y47EtyrU7RUJL
   96V9CiiFaiqd35uFd0kqtt2Colg7vt9w0IMrPd/34a0PNDHVPLP9h3dh1
   sWbf7SYC7GzXqTbV0dH18d/XDtTb03fWQSUzQWi1ELS9W/vtNd4lkRahc
   pUJTmUhXAHa1kVU9PgyV+tFHezBBMjCwtNmlMUz1sT90vohBFxEw8WE9u
   A==;
X-CSE-ConnectionGUID: TRqSRS0KQ5qxlwB8SOcxlw==
X-CSE-MsgGUID: E8Fwn4PzQc2lMrLWJDbfkQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11129"; a="18153714"
X-IronPort-AV: E=Sophos;i="6.09,198,1716274800"; 
   d="scan'208";a="18153714"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
  by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Jul 2024 17:02:51 -0700
X-CSE-ConnectionGUID: G8KWb4xcRBKh2ny6DDcF6w==
X-CSE-MsgGUID: Wr0JxQAxSFOsuD0GDE9OKw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,198,1716274800"; 
   d="scan'208";a="48349912"
Received: from cmdeoliv-mobl.amr.corp.intel.com (HELO localhost.localdomain) ([10.125.109.234])
  by fmviesa008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Jul 2024 17:02:49 -0700
...
Subject: [PATCH v2 2/4] platform/x86/intel/ifs: Add SBAF test image loading support
Date: Wed, 10 Jul 2024 17:02:31 -0700
Message-Id: <20240711000233.684642-3-sathyanarayanan.kuppuswamy@linux.intel.com>
